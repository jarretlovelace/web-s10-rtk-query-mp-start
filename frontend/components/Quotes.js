...
import { useGetQuotesQuery, useToggleFakeMutation, useDeleteQuoteMutation } from '../state/quotesApi'; // Fix import statement here
      ...
      .map(qt => (
        ...
        >
          ...
          <div className="quote-buttons">
            ...
            <button onClick={() => toggleFake({ id: qt.id, quote: { apocryphal: !qt.apocryphal } })}>FAKE</button> {/* Fix typo here */}
          </div>
        </div>
      ))}
